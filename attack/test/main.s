...
00000000000010a0 <freopen@plt>:
    ...
    10a4:	f2 ff 25 0d 2f 00 00 	bnd jmpq *0x2f0d(%rip)        # 3fb8 <freopen@GLIBC_2.2.5>
...
00000000000010c0 <gets@plt>:
    ...
    10c4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fc8 <gets@GLIBC_2.2.5>
...
00000000000010e0 <_start>:
    ...
    1101:	48 8d 3d 46 01 00 00 	lea    0x146(%rip),%rdi        # 124e <main>
...
0000000000001180 <__do_global_dtors_aux>:
    ...
    1184:	80 3d 9d 2e 00 00 00 	cmpb   $0x0,0x2e9d(%rip)        # 4028 <completed.8061>
    ...
    11ac:	c6 05 75 2e 00 00 01 	movb   $0x1,0x2e75(%rip)        # 4028 <completed.8061>
    11b3:	5d                   	pop    %rbp
    11b4:	c3                   	retq   
...
00000000000011c9 <success>:
    ...
    11d8:	e8 b3 fe ff ff       	callq  1090 <puts@plt>
    11dd:	bf 00 00 00 00       	mov    $0x0,%edi
    11e2:	e8 e9 fe ff ff       	callq  10d0 <exit@plt>
...
00000000000011e7 <fail>:
    ...
    11f6:	e8 95 fe ff ff       	callq  1090 <puts@plt>
    11fb:	90                   	nop
    11fc:	5d                   	pop    %rbp
    11fd:	c3                   	retq   
...
00000000000011fe <check>:
    ...
    1216:	e8 a5 fe ff ff       	callq  10c0 <gets@plt>
...
000000000000124e <main>:
    ...
    126e:	e8 2d fe ff ff       	callq  10a0 <freopen@plt>
    1273:	b8 00 00 00 00       	mov    $0x0,%eax
    1278:	e8 81 ff ff ff       	callq  11fe <check>
